...
class Register(models.Model):
    ...
    Contact_No = models.PositiveIntegerField(validators=[MaxValueValidator(99999999999)])
    CSI = models.PositiveIntegerField(default= 0,validators=[MaxValueValidator(999999999)])
